...
Location Attestations are **signed spatial records** that conform to the [Location Protocol v0.2](https://github.com/DecentralizedGeo/location-protocol-spec/tree/v0.2-draft) schema. They can represent points, polygons, routes, or any geospatial data.
...
<Warning>
  **Schema fields need verification** — The fields below are illustrative. Reference the v0.2 spec for the current schema definition.
</Warning>

| Field | Type | Description |
|-------|------|-------------|
| `locationType` | string | The type of location data (e.g., "GeoJSON") |
