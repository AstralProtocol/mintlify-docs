...
<Warning>
  **Development Preview** — Security audit pending.
</Warning>
...
│  Trust Assumptions                       │
├─────────────────────────────────────────┤
│  ✓ TEE executes code correctly          │
│  ✓ Astral operates service honestly     │
│  ✓ Signing key held securely in TEE     │
│  ✗ Input locations verified (future)    │
└─────────────────────────────────────────┘
```
...
<AccordionGroup>
  ...
  <Accordion title="Support key rotation" icon="rotate">
    ```solidity
    function updateSigner(address newSigner) external onlyMultisig {
