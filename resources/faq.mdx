...
<AccordionGroup>
  ...
  <Accordion title="Can users spoof their GPS?">
    ...
    We're researching [Location Proofs](https://collective.flashbots.net/t/towards-stronger-location-proofs/5323) — a framework for evidence-based location claims using multiple corroborating stamps. The aim is to raise the cost of spoofing, not to make it impossible. So far the ProofMode plugin is the only implemented proof-of-location source; others are planned. As more plugins are developed, they plug into Astral for stronger verification.
  </Accordion>
</AccordionGroup>
