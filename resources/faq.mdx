...
<AccordionGroup>
  ...
  <Accordion title="Can users spoof their GPS?">
    ...
    We're researching [Location Proofs](https://collective.flashbots.net/t/towards-stronger-location-proofs/5323) — a framework for evidence-based location claims using multiple corroborating stamps. The aim is to raise the cost of spoofing, not to make it impossible. The verify service registers verifiers for several proof-of-location systems (proofmode, witnesschain, gpsd, geoclue, wifi-mls, ip-geolocation) at varying maturity, with ProofMode the most developed device-side source. As these mature, they plug into Astral for stronger verification.
  </Accordion>
</AccordionGroup>
