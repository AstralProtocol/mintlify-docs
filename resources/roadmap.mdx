...
- [x] First plugin implementations (ProofMode, plus server-side verifiers for WitnessChain, gpsd, GeoClue, Wi-Fi/MLS, IP geolocation — at varying maturity)
- [ ] Harden and document each plugin's threat model
...
|---------|--------|-------|
| Full location proof verification | In progress | Verifiers for several PoL systems are live (experimental); hardening and multi-stamp correlation are ongoing |
