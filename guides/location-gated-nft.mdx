...
Create an NFT collection where each token can only be minted by someone physically at a specific location.

## Overview

This guide walks through:
1. Setting up the canonical location
...
First, create a permanent location attestation for the target location.
...
const LANDMARK_UID = '0x...';  // Your landmark
