...
The verify service registers verifiers for several proof-of-location systems — `proofmode`, `witnesschain`, `gpsd`, `geoclue`, `wifi-mls`, and `ip-geolocation` — at varying maturity in this research preview. Two are highlighted here:
