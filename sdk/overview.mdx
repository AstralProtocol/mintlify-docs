---
title: "SDK overview"
description: "Unified TypeScript SDK for Astral Location Services"
---
...
The Astral SDK is the official TypeScript client for Astral Location Services. It provides a unified interface for location attestations, verifiable geospatial computations, multifactor location proofs, and an extensible plugin system for proof-of-location integrations.
...
- **Plugin-extensible**: Register proof-of-location systems and get multifactor evidence bundles
