---
title: "API Overview"
description: "REST API for verifiable geospatial computations"
---

<Warning>
  **Development Preview** — This API specification is under development.
</Warning>

# API Reference

The Astral Compute API provides REST endpoints for verifiable geospatial operations.
...
The following table shows addresses for supported chains. The **Astral Signer** is the TEE address that signs delegated attestations—resolver contracts must verify attestations come from this address.

| Chain | Chain ID | EAS | Schema Registry | Astral Signer |
|-------|----------|-----|-----------------|---------------|
| Base Sepolia | 84532 | `0x4200000000000000000000000000000000000021` | `0x4200000000000000000000000000000000000020` | `0x2376192D7F1B50130f1aC3995Ad610251a06067C` |
| Base | 8453 | `0x4200000000000000000000000000000000000021` | `0x4200000000000000000000000000000000000020` | *Coming soon* |
