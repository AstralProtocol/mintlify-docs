...
- The `operation` field includes the radius parameter: `within:RADIUS` (e.g., `within:500` for a 500m radius). Resolver contracts should use prefix matching, not exact string comparison
